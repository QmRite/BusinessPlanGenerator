...
public class MarketingRequestTextGenerator extends AbstractRequestTextGenerator {
    ...
    public String getRequestText(String[] answers) {
        var template = "Выступай в качестве эксперта по бизнесу и напиши ответ на вопрос для для бизнеса." +
                " Отвечай развернуто. Ответ выдай в формате JSON в виде массива объектов с полями marketing," +
                " cost. Marketing - string, cost - integer. Размер массива: от 5 до 10 объектов." +
                " В ответе должны быть варианты продвижения продукта. Прочитай текст в тегах info" +
                " и отвечай подробно на его основе. [info] Информация о бизнесе: " +
                "Суть проекта: [1] " +
                "Сфера бизнеса: [2] " +
                "Место реализации: [3] " +
                "Способ реализации товара: [4] " +
                "Целевая аудитория: [5] " +
                "Спрос на рынке на данный товар: [6] " +
                "Конкуренты: [7] " +
                "Максимальный бюджет: [8] " +
                "[/info] " +
                "cost не должна превышать максимальный бюджет.";
